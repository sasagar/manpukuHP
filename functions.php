<?php
require get_template_directory() . '/class/mnpk_customizer.php';
require get_template_directory() . '/class/mnpk_post_has_archive.php';
require get_template_directory() . '/class/mnpk_load_styles.php';
