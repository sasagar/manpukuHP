...
<section class="mnpk-post">
    <div class="container">
        ...
        <article>
            ...
            <section id="namecard-generator-11">
                ...
                <div class="menu">
                    <section>
                        ...
                        <div>
                            ...
                            <div class="radio">
                                <input type="radio" id="Kill" name="q1" value="01" checked>
                                <label for="Kill">処理</label>
                            </div>
                            <div class="radio">
                                <input type="radio" id="Delivery" name="q1" value="02">
                                <label for="Delivery">納品</label>
                            </div>
                            <div class="radio">
                                <input type="radio" id="Balance" name="q1" value="03">
                    ...
                    <section>
                        ...
                        <p>今回の参加バッジは「タツタツタ」だ！</p>
                        <img src="<?php echo get_template_directory_uri(); ?>/images/namecard_base_11/tatsutatsuta.png"
                            alt="タツタツタ" class="tenpurabit">
