...
window.addEventListener('DOMContentLoaded', () => {
    // ラジオボタン
    document.getElementById('Kill').addEventListener("change", () => {
        drawing();
        tw_drawing();
    });
...
async function drawing() {
        ...
        if (elements.item(i).checked) {
            ...
            switch (checkValue) {
                case "01":
                    ...
                    break;
                case "02":
                    img_src = '/wp-content/themes/manpuku/images/namecard_base_11/delivery.png';
                    futa_color = "#ffffff";
                    name_color = "#000000";
                    team_color = "#000000";
                    event_color = "#ffffff";
    ...
    badge.src = '/wp-content/themes/manpuku/images/namecard_base_11/tatsutatsuta.png';
...
async function tw_drawing() {
    ...
    for (let i = 0; i < len; i++) {
        if (elements.item(i).checked) {
            ...
            switch (checkValue) {
                case "01":
                    img_src = '/wp-content/themes/manpuku/images/namecard_base_11/kill_tw.png';
                    futa_color = "#000000";
                    name_color = "#000000";
                    team_color = "#000000";
                    event_color = "#000000";
                    ...
                    break;
                case "02":
                    img_src = '/wp-content/themes/manpuku/images/namecard_base_11/delivery_tw.png';
                    futa_color = "#ffffff";
                    name_color = "#000000";
                    team_color = "#000000";
                    event_color = "#ffffff";
                    ...
                    break;
                case "03":
                    img_src = '/wp-content/themes/manpuku/images/namecard_base_11/balance_tw.png';
                    futa_color = "#ffffff";
                    name_color = "#ffffff";
                    team_color = "#000000";
                    event_color = "#ffffff";
